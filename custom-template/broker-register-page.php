<?php
/*
 Display Template Name: Broker Register
*/
...
if($first_name == "" || $last_name == "" || $username == "" || $email == "" || $password1 == "" || $password2 == "" || $vehicle1 == "" || $vehicle2 == "") 
	...
	$user_id = wp_insert_user( array ('first_name' => apply_filters
		     ('pre_user_first_name', $first_name), 
		      ...
		      'user_email' => apply_filters('pre_user_user_email', $email), 'role' => 'broker' ));
...
<section class="buyer_register_bradcrumb">
	<div class="container">
		<div class="row">
			<div class="col-lg-12">
				<a href="<?php echo site_url();?>">Home</a> <span>/ Register as a broker</span>
			</div>
		</div>
	</div>
</section>
...
<?php if(isset($error)){echo $error;}?>
			...
			<div class="broker_register_heading">
				<h2>Register for <span>Broker</span></h2>
			</div>
         <div class="row">
         	<div class="col-lg-12">
