<?php
/*
 Display Template Name: View Franchise Listing
*/
    ...
    <div class="list-group ">
            ...
            $image = wp_get_attachment_image_src( get_post_thumbnail_id( $post->ID ), 'full' );
             ?>
                ...
                <ul>
                <?php $edit_post = add_query_arg('editfranchise', get_the_ID(), 'http://demosrvr.com/wp/getabusiness/edit-franchise-page/'); ?>
                <li>
		...
		<?php $nonce = wp_create_nonce('franchise_delete_post_nonce') ?>
		<a href="<?php echo admin_url( 'admin-ajax.php?action=franchise_delete_post&id=' . get_the_ID() . '&nonce=' . $nonce ) ?>" data-id="<?php the_ID() ?>" data-nonce="<?php echo $nonce ?>" class="delete-post"><i class="fas fa-trash"></i></a>
	<?php endif ?>
				</li>
				</ul>
                </div>
