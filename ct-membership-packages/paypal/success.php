...
global $ct_options;
global $wpdb;
include_once(dirname(__FILE__).'/../CreateOrder.php');
...
<div class="email-data inner-content">
	<div class="response">
		...
		<span>Payment Status: <?php echo $payment_status; ?></span><br />
		<span>User Name: <?php echo $first_name." ".$last_name; ?></span><br />
		<span>User Email: <?php echo $payer_email; ?></span><br />
		<p class="marT20 marB20"><a class="btn" href="<?php echo site_url();?>/my-account/"><?php _e('View Your Listings', 'contempo'); ?></a></p>
	</div>
</div>
<?php
